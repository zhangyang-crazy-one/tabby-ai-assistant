...
@Component({
    ...
    template: `
        <div class="ai-sidebar-container">
            <!-- Titlebar - 品牌标题栏（可拖拽区域） -->
            <div class="ai-sidebar-titlebar" [class.macos]="isMacOS">
                <div class="titlebar-content">
                    <svg class="titlebar-logo" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <span class="titlebar-text">AI Assistant</span>
                </div>
            </div>
